...
public class DominoesTest {
	...
	public void singletonCantBeChainedTest() throws ChainNotFoundException {
		...
		expectedException.expectMessage(NO_DOMINO_CHAIN_FOUND);
...
//	 @Ignore("Remove to run test")
	...
	public void separateLoopsTest() throws ChainNotFoundException {
		...
		Domino[] dominoesArray = { new Domino(1, 2), new Domino(2, 3), new Domino(3, 1), new Domino(1, 1), new Domino(2, 2),
		    new Domino(3, 3) };
		List<Domino> dominoesList = Arrays.asList(dominoesArray);
	...
	public void nineElementsTest() throws ChainNotFoundException {
		Dominoes dominoes = new Dominoes();
		Domino[] dominoesArray = { new Domino(1, 2), new Domino(5, 3), new Domino(3, 1), new Domino(1, 2), new Domino(2, 4),
		    new Domino(1, 6), new Domino(2, 3), new Domino(3, 4), new Domino(5, 6) };
		List<Domino> dominoesList = Arrays.asList(dominoesArray);
	...
	private void assertValidChain(final List<Domino> inputDominoes, final List<Domino> outputDominoes) {
	...
	private void assertEndDominoesMatch(final List<Domino> outputDominoes) {
	...
	private void assertSameDominoes(final List<Domino> inputDominoes, final List<Domino> outputDominoes) {
	...
	private void assertConsecutiveDominoes(final List<Domino> dominoes) {
